...
import numpy as np
import Image, sys, array, string,re
...
extractor = Extractor()
by = getattr(extractor, algorithm )(n , channels , bitnum, options.vertical)
...
if len(by) > 0 :
    ...
    print 'Something wrong during extraction no data extracted..'
